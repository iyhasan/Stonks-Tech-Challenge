export type REVIEW_SOURCE_KEY = "Rotten Tomatoes" | "Internet Movie Database" | "Metacritic";

export const reviewSourceToLogoUrl: Record<REVIEW_SOURCE_KEY, string> = {
    'Rotten Tomatoes': 'https://upload.wikimedia.org/wikipedia/commons/6/6f/Rotten_Tomatoes_logo.svg',
